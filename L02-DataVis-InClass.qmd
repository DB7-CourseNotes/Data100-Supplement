...
To test your knowledge, we'll use the `mpg` data set, which is loaded when you load the `ggplot2` package.
...
3. The number of cylinders versus the classification of the car.
